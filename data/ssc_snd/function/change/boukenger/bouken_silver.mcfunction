...
execute if score @s ssc.form1n matches 0 unless score Form_Difference ssc.form1n matches 1 run function ssc_snd:play_global {name:"supersentaicraft:bouken_silver",scope:"change_snd"}
