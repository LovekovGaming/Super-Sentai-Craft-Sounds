...
execute if score @s ssc.form1n matches 0 unless score Form_Difference ssc.form1n matches 1 run playsound supersentaicraft:bouken_silver player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
