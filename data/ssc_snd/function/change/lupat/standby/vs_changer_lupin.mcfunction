...
execute if score @s ssc.seq1 matches 18 run playsound supersentaicraft:masqueraise player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if score @s ssc.seq1 matches 148 run playsound supersentaicraft:vs_changer_standby_lupin player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
