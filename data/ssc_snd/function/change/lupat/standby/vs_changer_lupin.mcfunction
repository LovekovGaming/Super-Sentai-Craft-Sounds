...
execute if score @s ssc.seq1 matches 18 run function ssc_snd:play_global {name:"supersentaicraft:masqueraise",scope:"change_snd"}
...
execute if score @s ssc.seq1 matches 148 run function ssc_snd:play_global {name:"supersentaicraft:vs_changer_standby_lupin",scope:"change_snd"}
