...
execute if score @s ssc.seq1 matches 18 run playsound supersentaicraft:miracle_masqueraise player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if score @s ssc.seq1 matches 66 run playsound supersentaicraft:vs_changer_standby_victory player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
