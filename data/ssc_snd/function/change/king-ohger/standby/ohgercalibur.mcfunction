...
execute if score @s ssc.change-stage matches 1 if score @s ssc.seq1 matches 100 run function ssc_snd:play_global {name:"supersentaicraft:hachi_ohger",scope:"change_snd"}
...
execute if score @s ssc.change-stage matches 1 if score @s ssc.seq1 matches 20 run function ssc_snd:play_global {name:"supersentaicraft:kuwagata_ohger",scope:"change_snd"}
...
execute if score @s ssc.change-stage matches 1 if score @s ssc.seq1 matches 40 run function ssc_snd:play_global {name:"supersentaicraft:tonbo_ohger",scope:"change_snd"}
...
execute if score @s ssc.change-stage matches 1 if score @s ssc.seq1 matches 60 run function ssc_snd:play_global {name:"supersentaicraft:kamakiri_ohger",scope:"change_snd"}
...
execute if score @s ssc.change-stage matches 1 if score @s ssc.seq1 matches 80 run function ssc_snd:play_global {name:"supersentaicraft:papillon_ohger",scope:"change_snd"}
...
execute if score @s ssc.seq1 matches 120 if score @s ssc.change-stage matches 1 run function ssc_snd:play_global {name:"supersentaicraft:ohgercalibur_standby_1",scope:"change_snd"}
execute if score @s ssc.seq1 matches 120 if score @s ssc.change-stage matches 2 run function ssc_snd:play_global {name:"supersentaicraft:ohgercalibur_standby_2",scope:"change_snd"}
execute if score @s ssc.seq1 matches 120 if score @s ssc.change-stage matches 3 run function ssc_snd:play_global {name:"supersentaicraft:ohgercalibur_standby_3",scope:"change_snd"}
execute if score @s ssc.seq1 matches 120 if score @s ssc.change-stage matches 4 run function ssc_snd:play_global {name:"supersentaicraft:ohgercalibur_standby_4",scope:"change_snd"}
execute if score @s ssc.seq1 matches 120 if score @s ssc.change-stage matches 5 run function ssc_snd:play_global {name:"supersentaicraft:ohgercalibur_standby_5",scope:"change_snd"}
