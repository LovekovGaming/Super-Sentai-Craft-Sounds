...
execute if score @s ssc.form1n matches 0 run playsound supersentaicraft:spider_kumonos player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
execute if score @s ssc.form1n matches 1 run playsound minecraft:entity.lightning_bolt.impact player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3 0.8
execute if score @s ssc.form1n matches 1 run playsound minecraft:entity.lightning_bolt.thunder player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
