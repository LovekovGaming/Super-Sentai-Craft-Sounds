...
execute if score @s ssc.form1n matches 0 run playsound supersentaicraft:lord_of_the_shugod player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
execute if score @s ssc.form1n matches 1 run playsound supersentaicraft:king_ohkuwagata_ohger player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
