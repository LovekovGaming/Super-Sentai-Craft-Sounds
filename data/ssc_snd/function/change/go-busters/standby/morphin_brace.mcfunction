...
execute if score @s ssc.seq1 matches 11 run playsound supersentaicraft:powered_custom player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
execute if score @s ssc.seq1 matches 25 run playsound supersentaicraft:custom_visor_open player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if score @s ssc.seq1 matches 46 run playsound supersentaicraft:its_morphin_time player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
execute if score @s ssc.seq1 matches 74 run playsound supersentaicraft:morphin_brace_standby player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
