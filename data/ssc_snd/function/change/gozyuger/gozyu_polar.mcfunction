...
execute if score @s ssc.form1n matches 0 unless score Form_Difference ssc.form1n matches 1 run playsound supersentaicraft:gozyu_polar player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if score @s ssc.form1n matches 1 unless score Form_Difference ssc.form1n matches -1 run playsound supersentaicraft:gozyu_polar player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if score @s ssc.form1n matches 2 unless score Form_Difference ssc.form1n matches 1 run playsound supersentaicraft:gozyu_polar_god player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
execute if score @s ssc.form1n matches 3 unless score Form_Difference ssc.form1n matches -1 run playsound supersentaicraft:gozyu_polar_god player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
