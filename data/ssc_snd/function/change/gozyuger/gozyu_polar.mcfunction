...
execute if score @s ssc.form1n matches 0 unless score Form_Difference ssc.form1n matches 1 run function ssc_snd:play_global {name:"supersentaicraft:gozyu_polar",scope:"change_snd"}
...
execute if score @s ssc.form1n matches 1 unless score Form_Difference ssc.form1n matches -1 run function ssc_snd:play_global {name:"supersentaicraft:gozyu_polar",scope:"change_snd"}
...
execute if score @s ssc.form1n matches 2 unless score Form_Difference ssc.form1n matches 1 run function ssc_snd:play_global {name:"supersentaicraft:gozyu_polar_god",scope:"change_snd"}
execute if score @s ssc.form1n matches 3 unless score Form_Difference ssc.form1n matches -1 run function ssc_snd:play_global {name:"supersentaicraft:gozyu_polar_god",scope:"change_snd"}
