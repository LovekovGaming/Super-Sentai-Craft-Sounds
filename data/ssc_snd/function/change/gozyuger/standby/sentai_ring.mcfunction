...
execute if score @s ssc.seq1 matches 39 run function ssc_snd:play_global {name:"supersentaicraft:sentai_ring",scope:"change_snd"}
...
execute if score @s ssc.seq1 matches 68 run function ssc_snd:play_global {name:"supersentaicraft:tega_sword_standby_sentai",scope:"change_snd"}
execute if score @s[advancements={ssc_snd:change/gozyuger/sentai_ring_standby={clap=true}}] ssc.seq1 matches 68 run function ssc_snd:play_global {name:"supersentaicraft:tega_sword_standby_clap_sentai",scope:"change_snd"}
