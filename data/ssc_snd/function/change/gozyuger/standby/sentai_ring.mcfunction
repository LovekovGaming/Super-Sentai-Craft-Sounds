...
execute if score @s ssc.seq1 matches 39 run playsound supersentaicraft:sentai_ring player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if score @s ssc.seq1 matches 68 run playsound supersentaicraft:tega_sword_standby_sentai player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
execute if score @s[advancements={ssc_snd:change/gozyuger/sentai_ring_standby={clap=true}}] ssc.seq1 matches 68 run playsound supersentaicraft:tega_sword_standby_clap_sentai player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
