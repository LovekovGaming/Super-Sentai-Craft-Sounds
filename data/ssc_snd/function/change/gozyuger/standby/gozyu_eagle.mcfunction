...
execute if score @s ssc.seq1 matches 64 run function ssc_snd:play_global {name:"supersentaicraft:tega_sword_standby_eagle",scope:"change_snd"}
execute if score @s[advancements={ssc_snd:change/gozyuger/gozyu_eagle_standby={clap=true}}] ssc.seq1 matches 64 run function ssc_snd:play_global {name:"supersentaicraft:tega_sword_standby_clap",scope:"change_snd"}
