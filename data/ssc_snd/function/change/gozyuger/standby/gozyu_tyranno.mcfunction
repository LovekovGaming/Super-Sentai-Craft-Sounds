...
execute if score @s ssc.seq1 matches 64 run playsound supersentaicraft:tega_sword_standby_tyranno player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
execute if score @s[advancements={ssc_snd:change/gozyuger/gozyu_tyranno_standby={clap=true}}] ssc.seq1 matches 64 run playsound supersentaicraft:tega_sword_standby_clap player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
