advancement revoke @s only ssc_snd:change/gozyuger/gozyu_unicorn_standby 2
scoreboard players add @s ssc.seq1 1

execute if score @s ssc.seq1 matches 39 run playsound supersentaicraft:clap_your_hands player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if score @s ssc.seq1 matches 64 run playsound supersentaicraft:tega_sword_standby_unicorn player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
execute if score @s[advancements={ssc_snd:change/gozyuger/gozyu_unicorn_standby={clap=true}}] ssc.seq1 matches 64 run playsound supersentaicraft:tega_sword_standby_clap player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
