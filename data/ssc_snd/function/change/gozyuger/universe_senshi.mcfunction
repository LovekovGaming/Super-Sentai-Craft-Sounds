...
execute if score @s[advancements={ssc_core:player_transformed=true}] ssc.form1n matches 3 run function ssc_snd:play_global {name:"supersentaicraft:killer_battle_japan",scope:"change_snd"}
execute if score @s[advancements={ssc_core:player_transformed=true}] ssc.form1n matches 21 run function ssc_snd:play_global {name:"supersentaicraft:bousou_red_racer",scope:"change_snd"}
execute if score @s[advancements={ssc_core:player_transformed=true}] ssc.form1n matches 30 run function ssc_snd:play_global {name:"supersentaicraft:armed_dekared",scope:"change_snd"}
execute if score @s[advancements={ssc_core:player_transformed=true}] ssc.form1n matches 44 run function ssc_snd:play_global {name:"supersentaicraft:zyuoh_gorilla_gozyuger",scope:"change_snd"}
...
execute if entity @s[advancements={ssc_core:player_transformed=false,ssc_snd:flags/gozyuger/persistent={powered_up_uw=true,orca_boost=false}}] run function ssc_snd:play_global {name:"supersentaicraft:gozyuger_engage",scope:"change_snd"}
...
execute if entity @s[advancements={ssc_core:player_transformed=true,ssc_snd:flags/gozyuger/persistent={powered_up_uw=true,orca_boost=false}}] unless score Form_Difference ssc.form1n matches -1..1 run function ssc_snd:play_global {name:"supersentaicraft:gozyuger_engage",scope:"change_snd"}
