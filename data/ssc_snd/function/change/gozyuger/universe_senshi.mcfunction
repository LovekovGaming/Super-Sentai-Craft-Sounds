...
execute if score @s[advancements={ssc_core:player_transformed=true}] ssc.form1n matches 3 run playsound supersentaicraft:killer_battle_japan player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
execute if score @s[advancements={ssc_core:player_transformed=true}] ssc.form1n matches 21 run playsound supersentaicraft:bousou_red_racer player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
execute if score @s[advancements={ssc_core:player_transformed=true}] ssc.form1n matches 30 run playsound supersentaicraft:armed_dekared player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
execute if score @s[advancements={ssc_core:player_transformed=true}] ssc.form1n matches 44 run playsound supersentaicraft:zyuoh_gorilla_gozyuger player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[advancements={ssc_snd:flags/gozyuger/persistent={orca_boost=true}}] run playsound supersentaicraft:orca_boost player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[advancements={ssc_snd:flags/gozyuger/persistent={powered_up_uw=false}}] run playsound supersentaicraft:gozyuger_engage player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[advancements={ssc_core:player_transformed=false,ssc_snd:flags/gozyuger/persistent={powered_up_uw=true,orca_boost=false}}] run playsound supersentaicraft:gozyuger_engage player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[advancements={ssc_core:player_transformed=true,ssc_snd:flags/gozyuger/persistent={powered_up_uw=true,orca_boost=false}}] unless score Form_Difference ssc.form1n matches -1..1 run playsound supersentaicraft:gozyuger_engage player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
