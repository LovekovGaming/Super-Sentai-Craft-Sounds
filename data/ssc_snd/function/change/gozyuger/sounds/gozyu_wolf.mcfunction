...
execute if score @s ssc.seq1 matches 26 if score @s ssc.form1n matches 0 run playsound supersentaicraft:gozyu_wolf player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if score @s ssc.seq1 matches 39 if score @s ssc.form1n matches 51 run playsound supersentaicraft:wild_power_up player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
