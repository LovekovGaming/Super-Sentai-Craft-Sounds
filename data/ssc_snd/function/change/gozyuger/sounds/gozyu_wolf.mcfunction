...
execute if score @s ssc.seq1 matches 26 if score @s ssc.form1n matches 0 run function ssc_snd:play_global {name:"supersentaicraft:gozyu_wolf",scope:"change_snd"}
...
execute if score @s ssc.seq1 matches 39 if score @s ssc.form1n matches 51 run function ssc_snd:play_global {name:"supersentaicraft:wild_power_up",scope:"change_snd"}
