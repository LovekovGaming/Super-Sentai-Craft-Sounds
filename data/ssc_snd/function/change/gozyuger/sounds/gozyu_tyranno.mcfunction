...
execute if score @s ssc.seq1 matches 26 if score @s ssc.form1n matches 0 run playsound supersentaicraft:gozyu_tyranno player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
advancement revoke @s only ssc_snd:change/gozyuger/gozyu_tyranno_seq