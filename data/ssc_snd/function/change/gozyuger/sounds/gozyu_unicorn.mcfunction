...
execute if score @s ssc.seq1 matches 26 if score @s ssc.form1n matches 0 run function ssc_snd:play_global {name:"supersentaicraft:gozyu_unicorn",scope:"change_snd"}
