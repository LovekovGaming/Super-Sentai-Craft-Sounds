...
execute if score @s ssc.seq1 matches 26 if score @s ssc.form1n matches 0 run playsound supersentaicraft:gozyu_leon player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~
...
execute if score @s ssc.seq1 matches 178 if score @s ssc.form1n matches 0 run title @a[scores={ssc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.supersentaicraft.gozyuger.gozyu_leon","color":"blue"}
execute if score @s ssc.seq1 matches 182 if score @s ssc.form1n matches 0 run title @a[scores={ssc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.supersentaicraft.gozyuger.gozyu_leon","color":"gold"}
execute if score @s ssc.seq1 matches 186 if score @s ssc.form1n matches 0 run title @a[scores={ssc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.supersentaicraft.gozyuger.gozyu_leon","color":"blue"}
...
advancement revoke @s only ssc_snd:change/gozyuger/gozyu_leon_seq