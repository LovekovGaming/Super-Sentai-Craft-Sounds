...
execute if score @s ssc.seq1 matches 50 run function ssc_snd:play_global {name:"supersentaicraft:emorgear_hisor",scope:"change_snd"}
...
execute if score @s ssc.seq1 matches 400 run function ssc_snd:play_global {name:"supersentaicraft:emorgear_hisor_press",scope:"change_snd"}
...
execute if score @s ssc.seq1 matches 466 run function ssc_snd:play_global {name:"supersentaicraft:emorgear_hisor",scope:"change_snd"}
...
execute if score @s ssc.seq1 matches 773 run function ssc_snd:play_global {name:"supersentaicraft:emorgear_hisor",scope:"change_snd"}
