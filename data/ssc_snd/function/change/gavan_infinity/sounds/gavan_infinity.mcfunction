...
execute if score @s ssc.seq1 matches 50 run playsound supersentaicraft:emorgear_gekido player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~
...
execute if score @s ssc.seq1 matches 400 run playsound supersentaicraft:emorgear_gekido_press player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 0.75
...
execute if score @s ssc.seq1 matches 466 run playsound supersentaicraft:emorgear_gekido player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~
...
execute if score @s ssc.seq1 matches 773 run playsound supersentaicraft:emorgear_gekido player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~
