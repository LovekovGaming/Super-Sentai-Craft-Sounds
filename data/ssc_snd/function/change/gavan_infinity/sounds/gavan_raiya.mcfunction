...
execute if score @s ssc.seq1 matches 50 run playsound supersentaicraft:emorgear_keeg player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if score @s ssc.seq1 matches 466 run playsound supersentaicraft:emorgear_keeg player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if score @s ssc.seq1 matches 773 run playsound supersentaicraft:emorgear_keeg player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
