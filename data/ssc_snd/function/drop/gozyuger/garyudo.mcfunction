...
execute if score @s ssc.change-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid] contents supersentaicraft:tega_june_ring run function ssc_snd:play_global {name:"supersentaicraft:sentai_ring_in_june",scope:"change_snd"}
...
execute if score @s ssc.change-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid] contents #ssc_snd:item_alias/tega_june_ring_garyudo run function ssc_snd:play_global {name:"supersentaicraft:tega_june_garyudo_start",scope:"change_snd"}
...
execute if score @s[advancements={ssc_snd:change/gozyuger/garyudo_standby={cock=false,1=true}}] ssc.change-stage matches 2..5 if entity @n[type=item,distance=..5,tag=valid] run function ssc_snd:play_global {name:"supersentaicraft:tega_june_cock",scope:"change_snd"}
