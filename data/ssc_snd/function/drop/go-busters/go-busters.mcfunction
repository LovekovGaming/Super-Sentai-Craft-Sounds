...
execute if score @s ssc.change-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid] contents supersentaicraft:custom_visor run function ssc_snd:play_global {name:"supersentaicraft:custom_visor_set",scope:"change_snd"}
...
execute if score @s ssc.change-stage matches 2 if items entity @n[type=item,distance=..5,tag=valid] contents #ssc_snd:changers/morphin_brace run function ssc_snd:play_global {name:"supersentaicraft:morphin_brace_dial_turn",scope:"change_snd"}
execute if score @s ssc.change-stage matches 2 if items entity @n[type=item,distance=..5,tag=valid] contents supersentaicraft:custom_visor run function ssc_snd:play_global {name:"supersentaicraft:custom_visor_activate",scope:"change_snd"}
...
execute if score @s ssc.change-stage matches 3 if entity @n[type=item,distance=..5,tag=valid] run function ssc_snd:play_global {name:"supersentaicraft:morphin_brace_open",scope:"change_snd"}
