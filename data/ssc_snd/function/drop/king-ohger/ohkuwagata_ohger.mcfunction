...
execute as @n[type=item,distance=..5,predicate=ssc_snd:valid_item] if items entity @s contents supersentaicraft:ohger_calibur_zero run tag @s add valid
...
execute if score @s ssc.change-stage matches 1 if entity @n[type=item,distance=..5,tag=valid] run playsound supersentaicraft:ohgercalibur_zero_start player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~
...
execute if score @s ssc.change-stage matches 2 unless items entity @s armor.feet supersentaicraft:oh_kuwagata_ohger_calibur_zero if entity @n[type=item,distance=..5,tag=valid] run advancement revoke @s from ssc_snd:change/king-ohger/root
execute if score @s ssc.change-stage matches 2 unless items entity @s armor.feet supersentaicraft:oh_kuwagata_ohger_calibur_zero if entity @n[type=item,distance=..5,tag=valid] run function ssc_snd:drop/common/equip_belt {item: "supersentaicraft:oh_kuwagata_ohger_calibur_zero"}
...
execute if score @s ssc.change-stage matches 2 if entity @n[type=item,distance=..5,tag=valid] run stopsound @a[scores={ssc.configs.change_snd=1},distance=..20] player supersentaicraft:ohgercalibur_zero_standby
