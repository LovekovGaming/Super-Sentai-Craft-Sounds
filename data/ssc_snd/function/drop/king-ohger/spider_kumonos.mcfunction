...
execute if score @s ssc.change-stage matches 1 unless items entity @s armor.feet supersentaicraft:spider_kumono_slayer if items entity @n[type=item,distance=..5,tag=valid] contents supersentaicraft:change_kumonos_key run function ssc_snd:play_global {name:"supersentaicraft:kumonos_key_in",scope:"change_snd"}
...
execute if score @s ssc.change-stage matches 1 if items entity @s armor.feet supersentaicraft:spider_kumono_slayer if items entity @n[type=item,distance=..5,tag=valid] contents supersentaicraft:change_kumonos_key run function ssc_snd:play_global {name:"supersentaicraft:kumonos_key_turn",scope:"change_snd"}
