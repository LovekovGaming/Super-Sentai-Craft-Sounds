...
execute if score @s ssc.change-stage matches 1 unless items entity @s armor.feet supersentaicraft:spider_kumono_slayer if items entity @n[type=item,distance=..5,tag=valid] contents supersentaicraft:change_kumonos_key run playsound supersentaicraft:kumonos_key_in player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
...
execute if score @s ssc.change-stage matches 1 if items entity @s armor.feet supersentaicraft:spider_kumono_slayer if items entity @n[type=item,distance=..5,tag=valid] contents supersentaicraft:change_kumonos_key run playsound supersentaicraft:kumonos_key_turn player @a[scores={ssc.configs.change_snd=1}] ~ ~1 ~ 3
