...
execute if score @s ssc.change-stage matches 1 if items entity @n[type=item,distance=..5,predicate=ssc_snd:valid_item] contents #ssc_snd:changers/accellular run function ssc_snd:play_global {name:"supersentaicraft:accellular_ready",scope:"change_snd"}
execute if score @s ssc.change-stage matches 2 if items entity @n[type=item,distance=..5,predicate=ssc_snd:valid_item] contents #ssc_snd:changers/accellular run function ssc_snd:play_global {name:"supersentaicraft:accellular_henshin_button",scope:"change_snd"}
