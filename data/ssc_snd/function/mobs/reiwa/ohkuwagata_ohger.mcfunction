...
execute at @e[type=supersentaicraft:oh_kuwagata_ohger,tag=!sounded] run playsound supersentaicraft:lord_of_the_shugod hostile @a[scores={ssc.configs.mob_snd=1}] ~ ~1 ~ 3
