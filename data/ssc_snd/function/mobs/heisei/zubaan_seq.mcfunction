...
execute at @e[type=supersentaicraft:zubaan,tag=!sounded,tag=sound_active,scores={ssc.seq1=140}] run playsound supersentaicraft:zubaan neutral @a[scores={ssc.configs.mob_snd=1}] ~ ~1 ~ 3
